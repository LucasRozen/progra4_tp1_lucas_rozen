namespace ej2{
    ...
    // Función para mostrar tareas según su estado y ordenadas por prioridad
    ...
    const returnTasksAfterThreeSeconds = () : Promise<Task[]> =>{ 
    ...
    const showTasksAsync = async () =>{

        console.log("cargando tareas...");
        // Creamos un array de tareas
        const tasks = await returnTasksAfterThreeSeconds();
